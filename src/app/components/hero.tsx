...
export default function Hero() {
  return (
    <div className="pt-26 pb-14 bg-[#eff3f3]">
      ...
      <div className=" w-full mt-8 md:mt-5 flex flex-col justify-center items-center md:flex md:w-[40%] md:p-0 md:flex-row md:gap-2 mx-auto ">
        <button className="bg-primary text-white text-[1rem] transition-all hover:shadow-2xl w-[95%] hover:translate-0.5 mt-2 py-4 md:py-3 rounded-lg border-2 border-primary font-bold">
          Register Now
        </button>
        <button className="hover:bg-primary hover:text-white text-[1rem] transition-all hover:shadow-2xl w-[95%] hover:translate-0.5 mt-2 py-4 md:py-3 rounded-lg bg-white border-2 border-primary text-primary font-bold">
          Join Waitlist
        </button>
      </div>
    </div>
